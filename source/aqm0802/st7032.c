...
void ST7032_i2c_send_command(uint8_t cmd)
{
	...
	write_count = i2c_Send_Data_Request(I2C0, I2C_SLAVE_AQM0802_ADDR>>1, st7032_command, 2);
...
void ST7032_i2c_send_data(uint8_t data)
{
	...
	write_count = i2c_Send_Data_Request(I2C0, I2C_SLAVE_AQM0802_ADDR>>1, st7032_data, 2);
	if(write_count!=2)while(1);
}
