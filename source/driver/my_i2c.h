...
extern uint32_t i2c_Config_Request(I2C_Type *base);
...
extern uint32_t i2c_Tx_Rx_Data_Request(I2C_Type *base, uint8_t *snd_buff, uint32_t snd_length, uint8_t *rcv_buff, uint32_t rcv_length);
